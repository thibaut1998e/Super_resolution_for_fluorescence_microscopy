...
if __name__ == "__main__":
    ...
    #resizing, norm. should also be split in train/valid
    test_images_path = f'{pth.myHome}/wide_field/wide_field_resized/deconv/c2' #3D images on which prediction is made
