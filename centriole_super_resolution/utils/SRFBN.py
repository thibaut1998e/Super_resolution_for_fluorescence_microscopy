...
class SRFBN(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, num_features=64, num_steps=4, num_groups=6, upscale_factor=2, act_type = 'prelu', norm_type = None):
    ...
    def forward(self, x):
        ...
        inter_res = nn.functional.interpolate(x, scale_factor=2, mode='bilinear', align_corners=False)
...
def SRFBN_learner(data, srfbn_args,**kwargs):
    model = SRFBN(**srfbn_args)
